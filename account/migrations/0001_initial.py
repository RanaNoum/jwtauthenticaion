    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_blogposts', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.ManyToManyField(blank=True, limit_choices_to={'service_type__in': [('web', 'Web Development'), ('mobile', 'Mobile App Development'), ('software', 'Software Development')]}, related_name='service_types', to='account.case')),
                ('industries', models.ManyToManyField(blank=True, to='account.industrie')),
