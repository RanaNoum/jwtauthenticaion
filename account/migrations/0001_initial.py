# Generated by Django 4.0.3 on 2024-04-27 16:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255)),
                ('description', models.TextField()),
                ('featured_image', models.ImageField(blank=True, null=True, upload_to='Casefeatured_images/')),
                ('service_type', models.CharField(choices=[('web', 'Web Development'), ('mobile', 'Mobile App Development'), ('software', 'Software Development')], max_length=100)),
