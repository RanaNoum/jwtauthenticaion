...
# from .views import CategoryViewSet, TechnologyViewSet, TestimonialViewSet, ProjectViewSet,ServiceViewSet, BlogPostViewSet, CommentViewSet, CompanyInformationViewSet,TeamMemberViewSet, AutherViewSet, ContactInquiryViewSet,SendPasswordResetEmailView, UserChangePasswordView, UserLoginView, UserProfileView, UserRegistrationView, UserPasswordResetView
...
# urlpatterns = [
#     path('functons/', include(router.urls)),
# ]
# urlpatterns = [
